...
class GdustApp extends StatelessWidget {
  const GdustApp({super.key});
  @override
    ...
    try {
      ...
      if (data.isNotEmpty) {
        ...
        setState(() {
          ...
          loaded = true;
          _loadedEmpty = false;
          _statusMsg = '同步完成：${data.length} 周，${data.values.fold(0, (s, l) => s + l.length)} 条课程';
